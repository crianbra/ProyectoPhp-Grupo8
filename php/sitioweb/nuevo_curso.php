...
<textarea class="form-control" name="description_curso" id="message" placeholder="Escriba una breve descriptiondel curso" style="height:100px;"></textarea>
</div>
<a href="courses.php"><button> Agregar</button> </a>
<br><br>
</div>
